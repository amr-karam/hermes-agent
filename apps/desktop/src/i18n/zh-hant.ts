...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      wallpaperTitle: '桌面壁紙',
      wallpaperDesc: '位於對話後方的圖片，會套用到你的桌面。',
      wallpaperChoose: '選擇…',
      wallpaperClear: '清除',
      wallpaperOpacity: '不透明度',
      wallpaperBlur: '模糊',
      wallpaperDarkTitle: '深色變體',
      wallpaperDarkDesc: '系統處於深色模式時使用的另一張圖片。',
      wallpaperDarkChoose: '選擇深色…',
      wallpaperFailed: '無法變更壁紙。',
      slideshowTitle: '壁紙輪播',
      slideshowDesc: '依時間間隔從資料夾中輪換桌面圖片。',
      slideshowFolderChoose: '資料夾…',
