...
export const ja = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      wallpaperTitle: 'デスクトップ壁紙',
      wallpaperDesc: '会話の背後に表示され、デスクトップに適用される画像です。',
      wallpaperChoose: '選択…',
      wallpaperClear: 'クリア',
      wallpaperOpacity: '不透明度',
      wallpaperBlur: 'ぼかし',
      wallpaperDarkTitle: 'ダーク用',
      wallpaperDarkDesc: 'システムがダークモードのときに使う別の画像です。',
      wallpaperDarkChoose: 'ダーク用を選択…',
      wallpaperFailed: '壁紙を変更できませんでした。',
      slideshowTitle: '壁紙スライドショー',
      slideshowDesc: 'フォルダーから一定間隔でデスクトップ画像を切り替えます。',
      slideshowFolderChoose: 'フォルダー…',
      slideshowInterval: '間隔',
       slideshowShuffle: 'シャッフル',
      orchestratorTitle: '??',
      orchestratorDesc: '??',
