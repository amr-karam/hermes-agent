...
export const en: Translations = {
  ...
  settings: {
    ...
    appearance: {
      ...
      wallpaperDesc: 'A picture behind the conversation, applied to your desktop.',
      wallpaperChoose: 'Choose…',
      wallpaperClear: 'Clear',
      wallpaperOpacity: 'Opacity',
      wallpaperBlur: 'Blur',
      wallpaperDarkTitle: 'Dark Variant',
      wallpaperDarkDesc: 'A separate picture used when the system is in dark mode.',
      wallpaperDarkChoose: 'Choose dark…',
      wallpaperFailed: 'Could not change the wallpaper.',
      slideshowTitle: 'Wallpaper Slideshow',
      slideshowDesc: 'Rotate the desktop picture from a folder on a timer.',
      slideshowFolderChoose: 'Folder…',
      slideshowInterval: 'Interval',
       slideshowShuffle: 'Shuffle',
      orchestratorTitle: 'Model Orchestrator',
      orchestratorDesc: 'Run two local models in parallel and coordinate their answers.',
      orchestratorModeTitle: 'Mode',
      orchestratorModeDesc: 'How the two models collaborate on each request.',
      orchestratorFanout: 'Fanout',
      orchestratorDebate: 'Debate',
      orchestratorDelegate: 'Delegate',
      orchestratorPrimaryModel: 'Primary model',
      orchestratorSecondaryModel: 'Secondary model',
      orchestratorHealth: 'Health',
      orchestratorRun: 'Run',
      orchestratorBusy: 'Running…',
      orchestratorUnavailable: 'Connect Ollama servers to enable.',
