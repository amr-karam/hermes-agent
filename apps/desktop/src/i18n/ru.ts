...
export const ru = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      wallpaperDesc: 'Изображение позади диалога, применяемое к рабочему столу.',
      wallpaperChoose: 'Выбрать…',
      wallpaperClear: 'Очистить',
      wallpaperOpacity: 'Непрозрачность',
      wallpaperBlur: 'Размытие',
      wallpaperDarkTitle: 'Вариант для тёмной темы',
      wallpaperDarkDesc: 'Отдельное изображение, когда система в тёмном режиме.',
      wallpaperDarkChoose: 'Выбрать тёмное…',
      wallpaperFailed: 'Не удалось сменить обои.',
      slideshowTitle: 'Слайдшоу обоев',
      slideshowDesc: 'Переключает обои рабочего стола из папки по таймеру.',
      slideshowFolderChoose: 'Папка…',
      slideshowInterval: 'Интервал',
       slideshowShuffle: 'Перемешать',
      orchestratorTitle: '??',
      orchestratorDesc: '??',
      orchestratorModeTitle: '??',
      orchestratorModeDesc: '??',
      orchestratorFanout: '??',
      orchestratorDebate: '??',
      orchestratorDelegate: '??',
      orchestratorPrimaryModel: '??',
      orchestratorSecondaryModel: '??',
      orchestratorHealth: '??',
      orchestratorRun: '??',
      orchestratorBusy: '??',
