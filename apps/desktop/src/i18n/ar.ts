...
export const ar = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      wallpaperTitle: 'خلفية سطح المكتب',
      wallpaperDesc: 'صورة خلف المحادثة، وتُطبَّق على سطح مكتبك.',
      wallpaperChoose: 'اختيار…',
      wallpaperClear: 'مسح',
      wallpaperOpacity: 'العتامة',
      wallpaperBlur: 'التمويه',
      wallpaperDarkTitle: 'نسخة داكنة',
      wallpaperDarkDesc: 'صورة منفصلة تُستخدم عندما يكون النظام في الوضع الداكن.',
      wallpaperDarkChoose: 'اختيار صورة داكنة…',
      wallpaperFailed: 'تعذّر تغيير الخلفية.',
      slideshowTitle: 'عرض شرائح الخلفية',
      slideshowDesc: 'تدوير صورة سطح المكتب من مجلد على مؤقت.',
      slideshowFolderChoose: 'مجلد…',
      slideshowInterval: 'الفاصل',
       slideshowShuffle: 'عشوائي',
      orchestratorTitle: '??',
      orchestratorDesc: '??',
