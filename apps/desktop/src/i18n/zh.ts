...
export const zh = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      wallpaperTitle: '桌面壁纸',
      wallpaperDesc: '位于对话后方的图片，会应用到你的桌面。',
      wallpaperChoose: '选择…',
      wallpaperClear: '清除',
      wallpaperOpacity: '不透明度',
      wallpaperBlur: '模糊',
      wallpaperDarkTitle: '深色变体',
      wallpaperDarkDesc: '系统处于深色模式时使用的另一张图片。',
      wallpaperDarkChoose: '选择深色…',
      wallpaperFailed: '无法更改壁纸。',
      slideshowTitle: '壁纸轮播',
      slideshowDesc: '按时间间隔从文件夹中轮换桌面图片。',
      slideshowFolderChoose: '文件夹…',
      slideshowInterval: '间隔',
       slideshowShuffle: '随机',
      orchestratorTitle: '??',
      orchestratorDesc: '??',
