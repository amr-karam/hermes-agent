...
production: true
description: Orchestrate Mixture of Agents (MoA) workflows in Hermes Agent Desktop. Coordinate multiple AI agents and models for complex tasks using voting, consensus, and ensemble methods.
---
