...
production: true
description: Enable team-based agent work and collaboration for Hermes Agent Desktop. Provides shared workspaces, skill sharing, session collaboration, multi-user workflows, and team-based analytics with permission controls.
---
