...
production: true
description: Enterprise-grade security auditing and vulnerability scanning for Hermes Agent Desktop. Provides automated security assessments, compliance checking, threat modeling, and secure coding practices validation.
---
