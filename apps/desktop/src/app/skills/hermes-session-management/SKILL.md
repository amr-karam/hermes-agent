...
production: true
description: Manage Hermes Agent Desktop session lifecycle, state persistence, and state.db SQLite operations. Save, load, export, and manage conversation sessions with full metadata support and recovery capabilities.
---
