...
production: true
description: Auto-discovers, loads, validates, and manages Hermes Agent Desktop skills. Provides skill registry, dependency resolution, performance monitoring, and lifecycle management for all Hermes-compatible skills.
---
