...
production: true
description: Manage Hermes Agent Desktop model providers (OpenRouter, Anthropic, OpenAI, Gemini, Groq, etc.) with intelligent switching, provider selection, and model configuration. Integrates with Hermes's /model command and provides enterprise-grade model management.
---
