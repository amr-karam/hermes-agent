...
production: true
description: Manage Hermes Agent Desktop profiles through AGENTS screen automation. Create, delete, switch profiles, configure model provider assignments, and manage profile templates for different use cases.
---
