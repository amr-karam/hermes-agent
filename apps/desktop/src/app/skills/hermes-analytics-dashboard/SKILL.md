...
production: true
description: Create and manage interactive analytics dashboards for Hermes Agent Desktop. Provides real-time visualization of skill performance, model usage, session analytics, and system metrics with customizable widgets and export capabilities.
---
