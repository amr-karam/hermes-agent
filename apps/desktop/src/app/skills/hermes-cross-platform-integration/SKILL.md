...
production: true
description: Enable cross-platform integration for Hermes Agent Desktop skills. Provides interoperability with external systems, cloud services, CI/CD pipelines, IDEs, and development tools through standardized APIs and adapters.
---
