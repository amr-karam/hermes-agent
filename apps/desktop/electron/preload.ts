...
contextBridge.exposeInMainWorld('hermesDesktop', {
  ...
  // Surface operations
  setTheme: payload => ipcRenderer.send('hermes:surface:theme', payload),
  setAccentColor: payload => ipcRenderer.send('hermes:surface:accent-color', payload),
  setWallpaper: payload => ipcRenderer.send('hermes:surface:wallpaper', payload),
  setTransparency: payload => ipcRenderer.send('hermes:surface:transparency', payload),
